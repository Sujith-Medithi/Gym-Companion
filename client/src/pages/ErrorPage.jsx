...
const ErrorPage = () => {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#0B0B14] px-4 text-center relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 h-72 w-72 rounded-full bg-primary/10 blur-3xl" aria-hidden="true"></div>
      <div className="absolute bottom-1/4 right-1/4 h-72 w-72 rounded-full bg-success/10 blur-3xl" aria-hidden="true"></div>
      ...
      <div className="relative z-10 w-full max-w-md rounded-2xl border border-white/10 bg-[#14142B]/85 p-8 shadow-2xl backdrop-blur-xl animate-fadeIn">
        ...
        <h1 className="text-8xl font-black text-white tracking-tight mb-2 select-none">
          404
        </h1>
        ...
        <Link
          to="/"
          className="inline-flex w-full items-center justify-center gap-2.5 rounded-xl bg-primary py-3.5 text-sm font-bold text-white shadow-lg shadow-[#6366F1]/30 transition-all hover:bg-[#5B52EE] active:scale-[0.98] cursor-pointer focus-visible:ring-2 focus-visible:ring-[#6366F1] focus:outline-none"
        >
