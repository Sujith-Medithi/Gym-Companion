...
export const createWorkout = async (req, res) => {
  try {
    const { exerciseName, date, duration, totalReps, accuracy, calories, completed, dayOfWeek, completedDates, isSpontaneous } = req.body;
    ...
    const workout = await Workout.create({
      ...
      isSpontaneous: isSpontaneous || false,
      dayOfWeek,
...
export const updateWorkout = async (req, res) => {
  try {
    ...
    if (isSpontaneous !== undefined) updateFields.isSpontaneous = isSpontaneous;
